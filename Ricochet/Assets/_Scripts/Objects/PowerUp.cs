...
public class PowerUp : MonoBehaviour
{
    ...
    private void UpdateSprite()
    {
        if (gameManagerInstance != null || GameManager.TryGetInstance(out gameManagerInstance))
        {
            powerupAnimator.runtimeAnimatorController = gameManagerInstance.GetPowerUpAC(instanceType);
            powerupSprite.sprite = gameManagerInstance.GetPowerUpSprite(instanceType);
        }
    }
    #endregion
}
